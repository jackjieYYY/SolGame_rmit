...
public class PlayerAgent_Demo3 : Agent
{

    public GameController_Demo3 aiGameController;
    ...
    public void Init(GameController_Demo3 controller)
    {
    ...
    void OnCollisionEnter(Collision collision)
    {
        ...
        {
            collision.gameObject.GetComponent<Boid_Demo3>().GameReset();
            AddReward(1f);
        }
    ...
    void Shoot(int input)
    {
        ...
        temp.GetComponent<Blast_Demo3>().Init(this);
